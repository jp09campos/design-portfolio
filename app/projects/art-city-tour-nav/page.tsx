          ...
          <div className="grid md:grid-cols-[1fr_340px] gap-10 items-end">
            <div>
              ...
              >
                ...
                <span className="text-xs text-white/30 px-2.5 py-1 rounded-full glass border border-white/08">2022</span>
              ...
              >
                Art City Tour<br />
                <span className="text-white/45">Navigation App</span>
              </motion.h1>
          ...
          <Reveal>
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              <div>
                ...
                <p className="text-white/50 text-sm">Interactive prototype live on Figma · Screens on Behance.</p>
              </div>
