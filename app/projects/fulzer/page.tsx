        ...
        <motion.div style={{ opacity: heroOpacity, y: heroY }} className="relative max-w-7xl mx-auto px-6 w-full">
          <div className="grid md:grid-cols-[1fr_3fr] gap-10 items-center">
            ...
            <motion.div
              ...
              className="hidden md:flex justify-center items-center self-center"
            >
              <Image
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Reveal delay={0.1}>
            <div className="mt-16 pt-16 border-t border-white/08">
              ...
              <Link href="/projects/art-city-tour-nav" className="group flex items-center justify-between py-4 border-t border-white/[0.07] hover:border-white/[0.14] transition-colors">
                <div>
                  <p className="font-display font-bold text-white text-lg">Art City Tour Nav</p>
