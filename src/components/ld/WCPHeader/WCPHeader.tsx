...
const SPARK_ICON = 'https://i5.walmartimages.com/dfw/63fd9f59-14e2/9d304ce6-96de-4331-b8ec-c5191226d378/v1/spark-icon.svg';
  ...
  return (
    <header className="ld-wcp-responsive-header-desktop-view">
      <div className="ld-wcp-responsive-header-desktop-content">
        ...
        >
          <img src={SPARK_ICON} alt="Walmart" width="36" height="36" className="ld-wcp-responsive-header-desktop-logo-img" />
        </a>
          ...
          <ul className="ld-wcp-responsive-header-desktop-nav-list">
            ...
            <li>
              <a href="#" className="ld-wcp-responsive-header-desktop-nav-button-cart" aria-label={`Cart contains ${cartCount} items`}>
                <CartIcon count={cartCount} price={cartPrice} textColor="var(--ld-semantic-color-top-nav-text-on-fill, white)" />
              </a>
            </li>
          </ul>
        </nav>
  ...
  return (
    <header className="ld-wcp-responsive-header-mobile-view">
      ...
      <div className="ld-wcp-responsive-header-mobile-row1">
        <a href="#" className="ld-wcp-responsive-header-mobile-logo-link" aria-label="Walmart Homepage">
          <SparkSvg size={32} />
        </a>
        <a
          href="#"
...
function TopNavSparkSvg({ size = 28 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 32 32" fill="none">
      <path fill="#FFC220" d="M10.887.645A2.2 2.2 0 0 1 14.643 2.2c0 .532-.534 6.187-.72 6.752a1.553 1.553 0 0 1-2.96 0c-.187-.565-.72-6.22-.72-6.752a2.2 2.2 0 0 1 .644-1.555ZM3.323 6.196a2.2 2.2 0 1 0-2.2 3.81c.46.266 5.624 2.632 6.207 2.753a1.552 1.552 0 0 0 1.48-2.562c-.396-.447-5.026-3.735-5.487-4.001Zm20.437 3.807c-.459.267-5.622 2.633-6.206 2.753a1.556 1.556 0 0 1-1.876-1.684c.035-.328.174-.636.396-.88.396-.444 5.026-3.733 5.487-3.999a2.2 2.2 0 0 1 2.2 3.81Zm-6.206 5.24c.583.121 5.746 2.487 6.207 2.754A2.202 2.202 0 0 1 24.567 21a2.2 2.2 0 0 1-3.004.805c-.461-.266-5.092-3.554-5.487-4a1.552 1.552 0 0 1 1.478-2.563Zm-5.111 2.722a1.561 1.561 0 0 0-1.48 1.081c-.186.565-.72 6.22-.72 6.752a2.2 2.2 0 1 0 4.4 0c0-.532-.533-6.187-.72-6.752a1.56 1.56 0 0 0-1.48-1.081Zm-11.318.03c.46-.268 5.623-2.634 6.207-2.754a1.556 1.556 0 0 1 1.876 1.685 1.553 1.553 0 0 1-.396.879c-.396.445-5.026 3.734-5.487 4a2.2 2.2 0 1 1-2.2-3.81Z" />
    </svg>
    ...
    <div className={cx('ld-wcp-responsive-header-mobile-view ld-wcp-responsive-header-mobile-topnav', variantClass)}>
      ...
      <div className="ld-wcp-responsive-header-mobile-topnav-topbar">
        ...
        <div className="ld-wcp-responsive-header-mobile-topnav-left">
          ...
          <a href="#" aria-label="Walmart Homepage" className="ld-wcp-responsive-header-mobile-topnav-logo-link">
            <TopNavSparkSvg size={28} />
          </a>
        </div>
